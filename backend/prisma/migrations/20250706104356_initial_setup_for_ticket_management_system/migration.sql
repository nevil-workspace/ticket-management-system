...
-- AddForeignKey
ALTER TABLE "_TicketWatchers" ADD CONSTRAINT "_TicketWatchers_A_fkey" FOREIGN KEY ("A") REFERENCES "Ticket"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_TicketWatchers" ADD CONSTRAINT "_TicketWatchers_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
